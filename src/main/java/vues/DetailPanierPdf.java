    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (panier == null) // il n'y a pas de paniers
            {
                ...
                Paragraph titre = new Paragraph("Facture", FontFactory.getFont(FontFactory.TIMES, 18, Font.BOLDITALIC, BaseColor.CYAN));
                ...
                {
                    Book a = (Book) panier.elementAt(index);
                    table.addCell(" " + a.getTitle() + " ");
                    table.addCell(" " + a.getPrice() + " Dollars");
